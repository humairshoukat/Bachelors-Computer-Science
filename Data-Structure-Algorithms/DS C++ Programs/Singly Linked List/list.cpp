	...
	if (headnode != nullptr)
	{
		...
		case 1:
		{
			...
			else if (currentnode->getnext()== nullptr)
			{
				delete currentnode;
				currentnode = headnode;
				lastcurrentnode->setnext(nullptr);
				s--;
			}
			else
			{
...
void list::update_list()
{
	if (headnode != nullptr)
	{
		...
		cout << "Enter new value: ";
		cin >> x;
		cout << "The last value: " << currentnode->get() << " at this position is now updated with new value: ";
		currentnode->set(x);
...
void list::get()
{
	if (headnode != nullptr)
	{
		if (lastcurrentnode != nullptr)
		{
			cout << "Last Current Node is: " << lastcurrentnode->get() << " and Current Node is: " << currentnode->get() << endl;
		}
		else
		{
			cout << "Last Current Node is: nullptr and Current Node is: " << currentnode->get() << endl;
		}
